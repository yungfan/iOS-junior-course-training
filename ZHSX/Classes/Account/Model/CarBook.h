...
@property (nonatomic, copy)  NSString *xfrq;//日期

- (instancetype)initWithBZ:(NSString*) bz andFkfs: (NSString *) fkfs andGls: (NSString *) gls andXfje:(NSString *)xfje andXmmc: (NSString *) xmmc andXfrq: (NSString *)xfrq;
